"""
Neural Network Agent Technology
Category: core
...
class AgentNeuralNetwork:
    """Neural Network - Advanced agent technology with 12 improvement functions"""
    
    def __init__(self, base_dir: Optional[str] = None):
        self.base_dir = base_dir or BASE_DIR
        self.tech_id = "agent_neural_network"
        self.tech_name = "Neural Network"
        self.category = "core"
        self.icon = "🧠"
...
# Global instance
agent_neural_network = AgentNeuralNetwork()
