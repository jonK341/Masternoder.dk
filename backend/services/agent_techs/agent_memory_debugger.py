"""
Memory Debugger Agent Technology
Category: tools
...
class AgentMemoryDebugger:
    """Memory Debugger - Advanced agent technology with 12 improvement functions"""
    
    def __init__(self, base_dir: Optional[str] = None):
        self.base_dir = base_dir or BASE_DIR
        self.tech_id = "agent_memory_debugger"
        self.tech_name = "Memory Debugger"
        self.category = "tools"
        self.icon = "🧪"
...
# Global instance
agent_memory_debugger = AgentMemoryDebugger()
