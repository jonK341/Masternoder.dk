"""
Network Scanner Agent Technology
Category: scanner
...
class AgentNetworkScanner:
    """Network Scanner - Advanced agent technology with 12 improvement functions"""
    
    def __init__(self, base_dir: Optional[str] = None):
        self.base_dir = base_dir or BASE_DIR
        self.tech_id = "agent_network_scanner"
        self.tech_name = "Network Scanner"
...
# Global instance
agent_network_scanner = AgentNetworkScanner()
