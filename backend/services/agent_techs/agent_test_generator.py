"""
Test Generator Agent Technology
Category: tools
...
class AgentTestGenerator:
    """Test Generator - Advanced agent technology with 12 improvement functions"""
    
    def __init__(self, base_dir: Optional[str] = None):
        self.base_dir = base_dir or BASE_DIR
        self.tech_id = "agent_test_generator"
        self.tech_name = "Test Generator"
        self.category = "tools"
        self.icon = "🧪"
...
# Global instance
agent_test_generator = AgentTestGenerator()
