...
class AgentMlPredictor:
    """ML Predictor - Advanced agent technology with 12 improvement functions"""
    
    def __init__(self, base_dir: Optional[str] = None):
        self.base_dir = base_dir or BASE_DIR
        self.tech_id = "agent_ml_predictor"
        self.tech_name = "ML Predictor"
...
# Global instance
agent_ml_predictor = AgentMlPredictor()
