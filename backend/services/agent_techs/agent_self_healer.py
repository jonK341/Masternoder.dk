...
class AgentSelfHealer:
    """Self Healer - Advanced agent technology with 12 improvement functions"""
    
    def __init__(self, base_dir: Optional[str] = None):
        self.base_dir = base_dir or BASE_DIR
        self.tech_id = "agent_self_healer"
        self.tech_name = "Self Healer"
...
# Global instance
agent_self_healer = AgentSelfHealer()
