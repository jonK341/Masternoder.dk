...
_Updated: 2026-07-03T11:40:23.845984Z_
...
- [ ] **#7** [engine] Spatial arb 0/11 executions — scan vs fund vs threshold chain (`arb_exec_zero`) — _preflight ok; arb_exec=0/11 best_bps=7.5 ai_exec=False cross_actions=7 ext_exec=0 user_agents= (2026-07-03)_
...
- [x] **#14** [funding] NonKYC DOGE inventory low for sell legs (~$25+ recommended) (`nonkyc_doge_low`) — _nonkyc DOGE $34.72 (458.96 DOGE) ≥ $25 (2026-07-03)_
