...
_Updated: 2026-07-04T04:43:35.040672Z_

- [x] **#1** [treasury] Live USD stash is $0 — no real external arb P&L captured yet (`live_stash_zero`) — _live stash USD=1.4688 (2026-07-04)_
...
- [ ] **#6** [engine] AI trader enabled but ai_exec=False every tick (`ai_trader_idle`) — _heartbeat ai_exec=False; platform_ok=True arb_exec=0/11 best_bps=-7.1 best_agent=arb_triangular_paper bes (2026-07-04)_
- [ ] **#7** [engine] Spatial arb 0/11 executions — scan vs fund vs threshold chain (`arb_exec_zero`) — _preflight ok; arb_exec=0/11 best_bps=-7.1 best_agent=arb_triangular_paper best_net=-7.1 min_ma (2026-07-04)_
...
- [x] **#14** [funding] NonKYC DOGE inventory low for sell legs (~$25+ recommended) (`nonkyc_doge_low`) — _nonkyc DOGE $34.80 (448.44 DOGE) ≥ $25 (2026-07-04)_
...
- [x] **#16** [treasury] Live venue compound on trade enabled but stash ledger empty (`treasury_compound`) — _live external stash credited USD=1.4688 (2026-07-04)_
...
- [ ] **#22** [research] Top skip reason insufficient_venue_balance — pre-fund quote legs (`skip_reason_funding`) — _partial: 40 rotation fills; last=reduce_notional $10.0 (2026-07-04) — prefund: scripts/prefund_arb_legs.py_
