...
_Roadmap version: 2026-07-04-batch2_
...
## Explorer (`/explorer`)
_Extends batch 1 items 1-10_

| # | Priority | Upgrade | Status | Batch 1 ref |
|---|----------|---------|--------|-------------|
| 101 | P0 | Daemon health banner with staking status | ✅ done | #8 |
| 102 | P0 | Block feed auto-scroll toggle | ✅ done | #1 |
| 103 | P1 | Manual refresh with age badge | ✅ done | #4 |
| 104 | P1 | SSE stream indicator with polling fallback | ✅ done | #5 |
| 105 | P1 | Network sparkline 5-day block trend | ✅ done | #6 |
...
## Exchange (`/exchange`)
_Extends batch 1 items 11-20_

| # | Priority | Upgrade | Status | Batch 1 ref |
|---|----------|---------|--------|-------------|
| 121 | P0 | Per-tab lazy load with retry | ✅ done | #15 |
| 122 | P0 | MN2 balance strip on trade tab | ✅ done | #16 |
| 123 | P1 | Per-tab refresh buttons | ✅ done | #14 |
| 124 | P1 | PayPal onramp shortcut nav pill | ✅ done | #17 |
| 125 | P1 | Profit Oracle deep link strip | ✅ done | #18 |
| 126 | P2 | Agent marketplace cross-link card | ✅ done | #19 |
| 127 | P2 | Venue liquidity heatmap mini | ✅ done | #20 |
| 128 | P2 | Hot pair search ticker | ✅ done | #11 |
| 129 | P2 | Treasury monitor sparkline | ✅ done | #12 |
| 130 | P3 | Arbitrage feed status chip | ✅ done | — |
| 131 | P3 | Bot daemon heartbeat | ✅ done | — |
| 132 | P3 | CEX tab load state badges | ✅ done | — |
| 133 | P1 | Exchange hub-pages UX toolbar | ✅ done | — |
...
## Profile (`/profile`)
_Extends batch 1 items 21-30_

| # | Priority | Upgrade | Status | Batch 1 ref |
|---|----------|---------|--------|-------------|
| 141 | P0 | PPP quest sync indicator badge | ✅ done | #24 |
| 142 | P1 | Stats route deep links strip | ✅ done | #25 |
| 143 | P1 | Leaderboard tab shortcut chip | ✅ done | #26 |
| 144 | P2 | Shop inventory preview widget | ✅ done | #27 |
| 145 | P2 | Social crew status chip | ✅ done | #28 |
| 146 | P2 | Trophy income estimate tile | ✅ done | #29 |
| 147 | P3 | Profile load time badge | ✅ done | #30 |
| 148 | P1 | MN2 wallet tx history link | ✅ done | #23 |
| 149 | P2 | Achievement unlock progress | ✅ done | — |
| 150 | P2 | Battle stats inline card | ✅ done | — |
...
| # | Priority | Upgrade | Status | Batch 1 ref |
|---|----------|---------|--------|-------------|
| 161 | P0 | Daily deal highlight strip | ✅ done | #34 |
| 162 | P1 | Sort by category and price | ✅ done | #35 |
| 163 | P2 | MN2 on-chain pay modal hint | ✅ done | #36 |
...
| 171 | P2 | Recommended items strip | ✅ done | — |
| 172 | P2 | Bundle deal calculator | ✅ done | — |
| 173 | P1 | Shop hub-pages UX toolbar | ✅ done | — |
| 174 | P2 | PayPal checkout shortcut | ✅ done | — |
| 175 | P3 | Wishlist localStorage | ✅ done | — |
| 176 | P3 | Recent purchases list | ✅ done | — |
| 177 | P2 | MN2 price refresh button | ✅ done | — |
| 178 | P2 | Inventory quick-view drawer | ✅ done | — |
| 179 | P3 | Shop version badge sync | ✅ done | — |
| 180 | P3 | Profit daemon shop cross-link | ✅ done | — |

## Casino (`/casino`)
_Extends batch 1 items 41-50_

| # | Priority | Upgrade | Status | Batch 1 ref |
|---|----------|---------|--------|-------------|
| 181 | P0 | Exchange bridge MN2 display | ✅ done | #44 |
| 182 | P1 | Live wins ticker | ✅ done | #45 |
...
| 190 | P2 | Slot spin history strip | ✅ done | — |
...
| 199 | P3 | Responsible gaming cool-down timer | ✅ done | — |
| 200 | P3 | Casino PPP quest hook | ✅ done | — |

## Generator (`/generator`)
_Extends batch 1 items 51-60_

| # | Priority | Upgrade | Status | Batch 1 ref |
|---|----------|---------|--------|-------------|
| 201 | P1 | Queue depth live counter | ✅ done | #54 |
| 202 | P2 | Credit balance display | ✅ done | #55 |
| 203 | P2 | Provider availability grid | ✅ done | #56 |
...
| 211 | P2 | Multi-provider failover badge | ✅ done | — |
| 212 | P1 | Generator hub-pages UX toolbar | ✅ done | — |
| 213 | P2 | Credit purchase shortcut | ✅ done | — |
...
_Extends batch 1 items 61-70_

| # | Priority | Upgrade | Status | Batch 1 ref |
|---|----------|---------|--------|-------------|
| 221 | P1 | Power monitor bar | ✅ done | #64 |
...
| 239 | P3 | Generator queue alert | ✅ done | — |
| 240 | P3 | Shop fulfillment backlog | ✅ done | — |

## Game Hub (`/game`)
_Extends batch 1 items 71-80_
...
## Quest (`/quests`)
_Extends batch 1 items 81-90_

| # | Priority | Upgrade | Status | Batch 1 ref |
|---|----------|---------|--------|-------------|
| 261 | P1 | Daily quest streak display | ✅ done | #84 |
| 262 | P2 | AI quest generation CTA | ✅ done | #85 |
...
| 270 | P2 | Battle-linked quests strip | ✅ done | — |
...
## Battle (`/battle`)
_Extends batch 1 items 91-100_
...
| 290 | P2 | RPS mode toggle badge | ✅ done | — |
