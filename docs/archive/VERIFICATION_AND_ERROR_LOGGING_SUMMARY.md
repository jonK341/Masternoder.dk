...
```bash
curl https://masternoder.dk/vidgenerator/api/errors/statistics  <!-- pragma: allowlist secret -->
```

### Get Recent Errors
```bash
curl https://masternoder.dk/vidgenerator/api/errors/recent?limit=10  <!-- pragma: allowlist secret -->
```

### Get Errors by Type
```bash
curl https://masternoder.dk/vidgenerator/api/errors/by-type/api_error_404  <!-- pragma: allowlist secret -->
```

### Get Errors by Endpoint
```bash
curl https://masternoder.dk/vidgenerator/api/errors/by-endpoint  <!-- pragma: allowlist secret -->
```
