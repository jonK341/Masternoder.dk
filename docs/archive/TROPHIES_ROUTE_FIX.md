...
**Issue:** 404 error on `https://masternoder.dk/vidgenerator/trophies`  <!-- pragma: allowlist secret -->
...
2. **Deploy to Server**
   ...
   - Test the route: `https://masternoder.dk/vidgenerator/trophies`  <!-- pragma: allowlist secret -->
