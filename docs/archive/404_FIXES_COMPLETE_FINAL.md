...
- **Problem:** Service files were missing on production server:  <!-- pragma: allowlist secret -->
...
- **Fix:** Deployed all missing service files to production  <!-- pragma: allowlist secret -->
...
- Deployed 5 missing service files to production  <!-- pragma: allowlist secret -->
...
**Root Cause:** Missing service files on production server prevented blueprints from loading.  <!-- pragma: allowlist secret -->
