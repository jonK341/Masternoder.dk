...
**Note:** These files are intentionally excluded as they are not needed in production.  <!-- pragma: allowlist secret -->
...
- [ ] No 404/500 errors in production logs  <!-- pragma: allowlist secret -->
...
- SSH connection to production server  <!-- pragma: allowlist secret -->
