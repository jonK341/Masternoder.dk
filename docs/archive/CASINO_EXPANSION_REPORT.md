...
**Date:** 2026-06-30 · **Branch:** `feat/casino-mega-expansion` · **Site:** [masternoder.dk/casino/](https://masternoder.dk/casino/)  <!-- pragma: allowlist secret -->
...
Review carefully before merge. A bad deploy can affect **live users** and public Discord channels. Always run the test bundle and production curl checklist after deploy.  <!-- pragma: allowlist secret -->
...
| | |
|---|---|
| **DONE** | Capacitor iOS project, entitlements `applinks:masternoder.dk`, PWA install, custom scheme `masternoder://` |  <!-- pragma: allowlist secret -->
| **TODO** | — |
...
```powershell
cd C:\Users\jonkh\UsecaseSampler\Masternoder.dk  <!-- pragma: allowlist secret -->
