...
# Production:  <!-- pragma: allowlist secret -->
BASE_URL=https://masternoder.dk python scripts/test_url_timing.py  <!-- pragma: allowlist secret -->
```
...
# Against production (replace with your URL if needed)  <!-- pragma: allowlist secret -->
set BASE_URL=https://masternoder.dk  <!-- pragma: allowlist secret -->
python scripts/test_all_button_endpoints.py
```
