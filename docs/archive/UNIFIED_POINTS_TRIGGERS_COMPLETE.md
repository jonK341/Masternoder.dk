...
- **Point Types Covered:**
  ...
  - Special (Death Portal, Production 10x, etc.)  <!-- pragma: allowlist secret -->
...
- Production Mastery: 750 XP, 375 Gen, 188 Battle  <!-- pragma: allowlist secret -->
...
- Production 10x: 3000 XP, 1500 Gen, 750 Battle  <!-- pragma: allowlist secret -->
