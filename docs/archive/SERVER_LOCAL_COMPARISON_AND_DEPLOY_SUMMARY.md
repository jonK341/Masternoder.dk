...
## Verify Routes on Production  <!-- pragma: allowlist secret -->

```bash
# Test generator endpoints
curl -s -o /dev/null -w "%{http_code}" https://masternoder.dk/vidgenerator/api/generator/test  <!-- pragma: allowlist secret -->
curl -s -o /dev/null -w "%{http_code}" https://masternoder.dk/vidgenerator/api/unified/status  <!-- pragma: allowlist secret -->
curl -s -o /dev/null -w "%{http_code}" https://masternoder.dk/vidgenerator/api/monetization/top-50  <!-- pragma: allowlist secret -->
```
