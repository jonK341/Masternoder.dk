...
### Test URLs
- Main site: https://masternoder.dk/vidgenerator  <!-- pragma: allowlist secret -->
- Database health: https://masternoder.dk/vidgenerator/api/health/database  <!-- pragma: allowlist secret -->
- Gallery search: https://masternoder.dk/vidgenerator/gallery?search=test  <!-- pragma: allowlist secret -->
