...
def deploy_redesign():
    print("="*80)
    print("DEPLOYING BATTLE PAGE REDESIGN")
    print("="*80)
    ...
    try:
        ...
        for local_file in FILES_TO_DEPLOY:
            ...
            # The app serves from /var/www/html/vidgenerator/vidgenerator/battle/index.html
            if local_file == "vidgenerator/battle/index.html":
                remote_file_path = f"{REMOTE_PATH_BASE}/vidgenerator/battle/index.html"
            else:
