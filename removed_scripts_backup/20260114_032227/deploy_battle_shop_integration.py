...
# -*- coding: utf-8 -*-
"""
Deploy Battle Shop Integration
"""
import paramiko
import os
import time
...
FILES_TO_DEPLOY = [
    {
        'local': 'vidgenerator/static/js/battle-shop-integration.js',
        'remote': '/var/www/html/vidgenerator/vidgenerator/static/js/battle-shop-integration.js'
    },
    {
...
def deploy():
    ...
    try:
        print("=" * 80)
        print("DEPLOYING BATTLE SHOP INTEGRATION")
        print("=" * 80)
        print()
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("=" * 80)
        print()
        print("Battle Shop Integration deployed!")
        print("All shop links now work smoothly with enhanced functionality.")
        print()
        print("Wait 15 seconds for service to fully restart, then test:")
        print("  - Visit: https://masternoder.dk/vidgenerator/battle")
        print("  - Click on 'Resources' tab to see shop quick access")
        print("  - All shop links now have smooth transitions and tracking")
        print()
    else:
        print()
        print("=" * 80)
