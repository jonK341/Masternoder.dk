#!/usr/bin/env python3
"""
Deploy vidgenerator_main.py fix to serve from file instead of hardcoded HTML
"""
import paramiko
...
def deploy_files():
    ...
    print("="*80)
    print("DEPLOYING VIDGENERATOR_MAIN FIX")
    print("="*80)
    ...
    try:
        ...
        print("="*80)
        print("\nThe front page should now show the updated content!")
        return True
