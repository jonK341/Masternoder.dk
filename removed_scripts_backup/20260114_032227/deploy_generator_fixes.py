...
# -*- coding: utf-8 -*-
"""
Deploy Generator Fixes - Fix API routes and calculator endpoints
"""
import paramiko
import os
import sys
...
def main():
    print("="*80)
    print("DEPLOYING GENERATOR FIXES")
    print("="*80)
    ...
    try:
        ...
        print("="*80)
        print("Generator Fixes deployed!")
        print("\nFixes Applied:")
        print("[OK] Added /vidgenerator prefix to video-generation/calculate route")
        print("[OK] Added /vidgenerator prefix to video-generation/solve-problems route")
        print("[OK] Added /vidgenerator prefix to points/get-all-connected route")
