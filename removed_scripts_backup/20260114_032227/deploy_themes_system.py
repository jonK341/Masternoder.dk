#!/usr/bin/env python3
"""
Deploy themes system: WWii, MTG, Ctrl a Delete, The End, SlåPrygl%er
"""
import paramiko
...
# Files to deploy
FILES_TO_DEPLOY = [
    'backend/services/themes_system.py',
...
def deploy_files():
    ...
    try:
        ...
        print("="*80)
        print("\nNew themes deployed:")
        print("  - WWii (World War II) - Historical documentary")
        print("  - MTG (Magic: The Gathering) - Fantasy card game")
        print("  - Ctrl+A Delete - Tech/cyberpunk")
        print("  - The End - Apocalyptic")
        print("  - SlåPrygl%er - Intense action")
        return True
