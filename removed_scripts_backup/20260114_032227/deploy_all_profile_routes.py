...
try:
    print("=" * 80)
    print("DEPLOYING ALL PROFILE ROUTES")
    print("=" * 80)
    ...
    stdin, stdout, stderr = ssh_client.exec_command("find /var/www/html/vidgenerator -name '*.pyc' -delete 2>/dev/null || true")
    stdout.channel.recv_exit_status()
    print("[OK] .pyc files removed")
    ...
    print("=" * 80)
    print("\nProfile route added to BOTH stats and game blueprints")
    print("URL: https://masternoder.dk/vidgenerator/profile")
    print("\nWaiting 10 seconds for services to fully restart...")
