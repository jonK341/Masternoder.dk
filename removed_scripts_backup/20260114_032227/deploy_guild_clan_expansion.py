...
# -*- coding: utf-8 -*-
"""
Deploy Guild/Clan expansion, Wars, Arena, and City Scenarios
"""
import paramiko
...
FILES_TO_DEPLOY = [
    ...
    'backend/services/arena_system.py',
    'backend/routes/guild_clan_operations.py',
    'backend/register_blueprints.py',
]

def deploy():
    print("="*80)
    print("DEPLOYING GUILD/CLAN EXPANSION, WARS, ARENA, CITY SCENARIOS")
    print("="*80)
    ...
    try:
        ...
        print("="*80)
        print("\nDeployed features:")
        print("  - Guild and Clan System")
        print("  - Wars between Guilds/Clans")
        print("  - Arena System")
        print("  - City Scenarios")
        print("  - API Routes for all features")
        return True
