#!/usr/bin/env python3
"""
Deploy generator page with new themes
"""
import paramiko
...
def deploy_files():
    ...
    print("="*80)
    print("DEPLOYING GENERATOR PAGE WITH NEW THEMES")
    print("="*80)
    ...
    try:
        ...
        print("="*80)
        print("\nGenerator page updated with new themes:")
        print("  - WWii (World War II)")
        print("  - MTG (Magic: The Gathering)")
        print("  - Ctrl+A Delete")
        print("  - The End")
        print("  - SlåPrygl%er")
        return True
