...
# -*- coding: utf-8 -*-
"""
Deploy Frontpage Links Fix to Server
"""
import paramiko
import os
import time
...
def deploy():
    """Deploy frontpage with link fixes"""
    try:
        print("=" * 80)
        print("DEPLOYING FRONTPAGE LINKS FIX")
        print("=" * 80)
        print()
        ...
        # Restart uWSGI to ensure changes are loaded
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("=" * 80)
        print()
        print("Frontpage with link fixes has been deployed!")
        print("The link validation system will now handle broken links gracefully.")
        print()
        print("Test the frontpage at: https://masternoder.dk/vidgenerator/")
        print()
    else:
        print()
        print("=" * 80)
