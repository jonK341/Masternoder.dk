...
# -*- coding: utf-8 -*-
"""
Deploy Game Page Fix
Deploy updated game page and connect-all-point-counters.js
"""
import paramiko
import os
import sys
...
def main():
    ...
    try:
        ...
        commands = [
            f'chmod 644 {BASE_PATH}/vidgenerator/game/index.html 2>/dev/null || true',
            f'chmod 644 {BASE_PATH}/vidgenerator/static/js/connect-all-point-counters.js 2>/dev/null || true',
        ]
        for cmd in commands:
        ...
        print("="*80)
        print("  [OK] Removed reference to non-existent connect-all-point-counters.js")
        print("  [OK] Created connect-all-point-counters.js stub file")
        print("  [OK] All static files should now load correctly")
