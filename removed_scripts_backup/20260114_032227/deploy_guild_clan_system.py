...
# -*- coding: utf-8 -*-
"""
Deploy Guild and Clan System - Wars, Arenas, City Scenarios, Metropolis Operations
"""
import paramiko
...
FILES_TO_DEPLOY = [
    'backend/services/guild_clan_system.py',
    'backend/routes/guild_clan.py',
    'backend/register_blueprints.py',
]

def deploy():
    print("="*80)
    print("DEPLOYING GUILD AND CLAN SYSTEM")
    print("="*80)
    ...
    try:
        ...
        print("="*80)
        print("\nGuild and Clan System deployed:")
        print("  - Guild/Clan creation and management")
        print("  - War declaration system")
        print("  - Arena system")
        print("  - City scenarios")
        print("  - Metropolis operations")
        print("  - Hash-based ID verification")
        return True
