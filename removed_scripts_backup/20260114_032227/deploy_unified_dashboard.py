...
def deploy_all():
    ...
    try:
        ...
        print("="*70)
        print("DEPLOYING UNIFIED DASHBOARD")
        print("="*70)
        ...
        print("="*70)
        print("\n[INFO] Unified Dashboard deployed:")
        print("  [OK] Unified Dashboard HTML")
        print("  [OK] Unified Dashboard API routes")
        print("  [OK] Blueprint registration")
        print("\n[INFO] Access at: /vidgenerator/unified-dashboard")
