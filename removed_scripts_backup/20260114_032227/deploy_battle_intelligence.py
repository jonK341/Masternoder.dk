"""
Deploy Battle Intelligence & Butterfly Loop Matrix Systems
"""
import paramiko
import os
import sys
...
FILES_TO_DEPLOY = [
    ...
    # Frontend Assets
    'vidgenerator/static/js/butterfly-loop-matrix.js',
...
def deploy_files():
    ...
    try:
        print("=" * 80)
        print("DEPLOYING BATTLE INTELLIGENCE & BUTTERFLY LOOP MATRIX SYSTEMS")
        print("=" * 80)
        print()
        ...
        print("   • Activity Points System (Visitor Tracking)")
        print("   • Battle Intelligence System (AI-Powered)")
        print("   • Butterfly Loop Matrix (Hypnotic Attraction)")
        print("   • Advanced Graphic Effects")
        print("   • All API Routes")
        print("   • Battle Page Integration")
        print()
        print("🔗 Test URLs:")
        print(f"   - https://{SERVER_HOST}/vidgenerator/battle")
        print(f"   - https://{SERVER_HOST}/vidgenerator/api/activity-points/leaderboard")
        print(f"   - https://{SERVER_HOST}/vidgenerator/api/battle/intelligence/mode/quick")
        print()
