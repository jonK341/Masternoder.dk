#!/usr/bin/env python3
"""
Deploy video generator with .env loading fix
"""
import os
import sys
import paramiko
...
# Files to deploy
FILES_TO_DEPLOY = [
    ("src/services/video_generation/video_generator.py", f"{REMOTE_PATH}/src/services/video_generation/video_generator.py"),
]

def deploy():
    """Deploy video generator with .env loading"""
    ssh_client = paramiko.SSHClient()
    ssh_client.set_missing_host_key_policy(paramiko.AutoAddPolicy())
    
    try:
        print("=" * 80)
        print("DEPLOYING VIDEO GENERATOR WITH .ENV LOADING")
        print("=" * 80)
        ...
        print("=" * 80)
        print()
        print("✅ Video generator updated with .env loading")
        print("   API keys should now be loaded from .env file")
