...
# -*- coding: utf-8 -*-
"""
Deploy Battle Stats Files to Server
"""
import paramiko
import os
import time
...
FILES_TO_DEPLOY = [
    {
        'local': 'backend/services/battle_stats_service.py',
        'remote': '/var/www/html/vidgenerator/backend/services/battle_stats_service.py'
    },
    {
        'local': 'backend/routes/battle_stats_endpoints.py',
        'remote': '/var/www/html/vidgenerator/backend/routes/battle_stats_endpoints.py'
    },
    {
        'local': 'backend/routes/game.py',
        'remote': '/var/www/html/vidgenerator/backend/routes/game.py'
    },
    {
    ...
    {
        'local': 'vidgenerator/static/js/battle-stats-display.js',
        'remote': '/var/www/html/vidgenerator/static/js/battle-stats-display.js'
    },
    {
...
def deploy():
    """Deploy all battle stats files"""
    try:
        print("=" * 80)
        print("DEPLOYING BATTLE STATS FILES")
        print("=" * 80)
        print()
