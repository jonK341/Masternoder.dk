...
# -*- coding: utf-8 -*-
"""
Deploy Generator Points Fix - Fix API endpoint calls
"""
import paramiko
import os
import sys
...
def main():
    print("="*80)
    print("DEPLOYING GENERATOR POINTS FIX")
    print("="*80)
    ...
    try:
        ...
        print("="*80)
        print("Generator Points Fix deployed!")
        print("\nFixes Applied:")
        print("[OK] Added URL logging to debug API calls")
        print("[OK] Added fallback URL for points endpoint")
