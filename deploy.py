...
FILES_TO_DEPLOY = [
    ...
    "scripts/mn2_pool_agent_tick.py",
    "cron/mn2_pool_agent_tick.sh",
    "cron/masternoder-mn2-pool.cron.d",
    # Crypto exchange + MN2 swoop pool + wallet hub
    ...
    "backend/services/crypto_exchange_risk_service.py",
    "backend/services/crypto_exchange_gateway_service.py",
    "backend/services/crypto_exchange_admin_service.py",
    "backend/services/crypto_exchange_profit_agent_service.py",
    "backend/services/exchange_swoop_service.py",
    "backend/services/exchange_mn2_pool_service.py",
    "backend/services/exchange_mn2_pool_agent_service.py",
    "backend/services/exchange_ops_service.py",
    "backend/services/exchange_ops_sell_service.py",
    "backend/services/exchange_ops_digest_service.py",
    "backend/services/exchange_agent_sweeper_service.py",
    "backend/services/exchange_external_bridge_service.py",
    ...
    "data/exchange_mn2_pool_config.json",
    "data/exchange_ops_config.json",
    "scripts/ops_digest_tick.py",
    "scripts/agent_sweeper_tick.py",
    "cron/mn2_pool_agent_light_tick.sh",
    "cron/ops_digest_tick.sh",
    "cron/agent_sweeper_tick.sh",
    "cron/masternoder-mn2-pool-light.cron.d",
    "cron/masternoder-mn2-pool-full.cron.d",
    "cron/masternoder-ops-digest.cron.d",
    "cron/masternoder-agent-sweeper.cron.d",
    "exchange/index.html",
    "wallets/index.html",
