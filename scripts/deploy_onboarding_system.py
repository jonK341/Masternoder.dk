#!/usr/bin/env python3
"""
Deploy Onboarding System - Deploy all onboarding components
"""
import paramiko
import os
import sys
...
FILES_TO_DEPLOY = [
    ...
    "vidgenerator/static/js/onboarding-manager.js",
    "vidgenerator/static/css/onboarding.css",
    "vidgenerator/index.html"
]

def deploy_onboarding_system():
    """Deploy onboarding system"""
    print("=" * 70)
    print("Onboarding System - Production Deployment")
    print("=" * 70)
    ...
    try:
        ...
        print()
        print("=" * 70)
        print("✅ Onboarding System Deployed!")
        print("=" * 70)
        print()
        print("Features Deployed:")
        print("  - Enhanced onboarding service with step tracking")
        print("  - Onboarding API endpoints (start, complete-step, status, progress)")
        print("  - Onboarding frontend manager (JavaScript)")
        print("  - Onboarding UI components (CSS)")
        print("  - Integrated into main index.html")
        print()
        print("Next Steps:")
        print("  1. Wait 15-20 seconds for services to fully initialize")
        print("  2. Test onboarding: Visit site as new user")
...
if __name__ == "__main__":
    success = deploy_onboarding_system()
