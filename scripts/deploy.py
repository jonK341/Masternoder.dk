...
MANIFESTS = {
    ...
    "mn2_staking": [
        ...
        "backend/services/casino_hub_service.py",
        "backend/routes/casino_routes.py",
        "data/casino_hub_config.json",
        ...
        "backend/routes/social_platform_routes.py",
        "backend/routes/youtube_routes.py",
        "backend/routes/facebook_routes.py",
        "backend/services/social_platform_fanout_service.py",
        "backend/services/youtube_fanout_service.py",
        "backend/services/discord_controller_service.py",
        "backend/services/discord_signature_service.py",
        "backend/services/discord_role_connection_service.py",
        "backend/services/discord_setup_service.py",
        "data/discord_app_profile.json",
        "legal/terms/index.html",
        "legal/privacy/index.html",
        "discord/verify/index.html",
        "static/discord-branding/discord-app-icon.png",
        "static/discord-branding/discord-app-icon-1024.png",
        "static/discord-branding/discord-app-icon.gif",
        "static/discord-branding/discord-app-banner.png",
        "static/discord-branding/discord-app-banner.gif",
        "scripts/build_discord_branding.py",
        "backend/services/facebook_casino_bot_service.py",
        "data/social_platform_fanout_config.json",
        "data/facebook_casino_bot_config.json",
        ...
        "cron/social_platform_fanout.sh",
