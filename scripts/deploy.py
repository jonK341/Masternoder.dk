...
MANIFESTS = {
    ...
    "business_control": [
        ...
        "backend/services/exchange_profit_orchestrator_service.py",
        "backend/services/exchange_spot_reuse_service.py",
        "backend/services/exchange_fleet_activation_service.py",
        "backend/services/exchange_dormant_agents_service.py",
        "backend/services/exchange_grid_signal_service.py",
        "backend/services/exchange_signal_stack_service.py",
        "backend/services/exchange_agent_profit_learning_service.py",
        "backend/services/exchange_marketplace_daemon_service.py",
        "backend/services/portal_micro_chain_service.py",
        "backend/services/monitor_5d_pulse_service.py",
        "backend/services/profit_daemon_news_service.py",
        "data/crypto_exchange/portal_micro_chain_config.json",
        "data/crypto_exchange/spot_reuse_config.json",
        "scripts/unified_trading_daemon.py",
        "scripts/run_unified_trading_daemon.cmd",
        "scripts/all_profit_daemons.py",
        "scripts/run_all_profit_daemons.cmd",
        "scripts/exchange_master_daemon.py",
        "scripts/_daemon_env.cmd",
        "scripts/local_business_control_server.py",
