...
MANIFESTS = {
    ...
    "casino": [
        ...
        "backend/services/casino_upgrades_service.py",
        ...
        "static/js/casino.js",
        "static/js/casino-upgrades.js",
        "static/js/casino-cockpit.js",
    ...
    "mn2_staking": [
        ...
        "backend/services/mn2_micro_tx_service.py",
        "backend/services/micro_tx_hooks.py",
        "backend/services/game_mn2_rewards.py",
        "backend/services/casino_service.py",
        "backend/services/casino_social_service.py",
        "backend/services/trophy_level_service.py",
        "backend/services/trophy_quest_service.py",
        "backend/services/creator_rating_service.py",
        ...
        "backend/routes/mn2_micro_tx_routes.py",
        "data/mn2_micro_tx_config.json",
        "static/js/mn2-micro-tx.js",
        "docs/MN2_MICRO_TX.md",
        "cron/mn2_micro_tx_batch.sh",
        ...
        "backend/services/activity_monitor_service.py",
        ...
        "shop/index.html",
        "hosting/index.html",
        "hosting/hosting-ui.css",
        "static/js/hosting-hub.js",
        "generator/index.html",
        "camgirls/index.html",
    ...
    # Super Encoder creator app — music hook, MN2 ratings, mobile PWA
    "creator": [
        "backend/services/super_encoder_service.py",
        "backend/services/creator_rating_service.py",
        "backend/services/music_api_service.py",
        "backend/routes/creator_routes.py",
        "backend/routes/all_page_routes.py",
        "backend/register_blueprints.py",
        "data/creator_config.json",
        "data/creator_tracks.json",
        "data/creator_ratings.json",
        "data/mn2_config.json",
        "creator/index.html",
        "creator/manifest.webmanifest",
        "static/js/creator-app.js",
        "static/js/creator-mobile.js",
        "static/css/creator-app.css",
        "docker/suno-api/docker-compose.yml",
        "docker/suno-api/.env.example",
        "scripts/setup_suno_proxy.sh",
        ".env.example",
        "index.html",
        "manifest.webmanifest",
        "tests/unit/test_super_encoder.py",
        "static/downloads/masternoder-creator.apk",
    ],
}
