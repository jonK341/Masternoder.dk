...
MANIFESTS = {
    ...
    "mn2_staking": [
        ...
        "backend/services/mn2_network_peers_service.py",
        "backend/services/mn2_release_catalog_service.py",
        "backend/services/mn2_wallet_hub_service.py",
        "backend/services/mn2_network_peers_service.py",
        "backend/services/mn2_spork_service.py",
        ...
        "static/css/mn2-wallets.css",
        "static/js/mn2-wallets.js",
