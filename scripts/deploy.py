...
MANIFESTS = {
    ...
    "mn2_staking": [
        ...
        "cron/discord_fleet_stream_fanout.sh",
    ...
    "business_control": [
        ...
        "static/css/game-hub-panel.css",
        "data/platform_news.json",
        "data/podcast_portal_lines.json",
        "static/js/podcast-portal-lines.js",
        "data/fleet_stream_chapters.json",
        "backend/services/fleet_stream_composer_service.py",
        "static/js/fleet-stream-chat.js",
        "static/css/fleet-stream-chat.css",
        "data/fleet_stream_live.json",
        ...
        "cron/discord_fleet_stream_fanout.sh",
        "static/css/stream-chapter-composer.css",
        "static/js/stream-chapter-composer.js",
        "static/js/camgirls-stream-voice.js",
        "static/css/camgirls-stream-voice.css",
        "static/js/streamer-voice-bootstrap.js",
        "static/css/fleet-progress-monitor-5d.css",
    "static/js/fleet-progress-monitor-5d.js",
    "data/fleet_monitor_themes.json",
    "backend/services/fleet_monitor_visual_service.py",
    "static/js/fleet-monitor-visual.js",
    "data/fleet_bot_visuals.json",
    "backend/services/fleet_bot_visuals_service.py",
    "static/img/fleet/default-bot.svg",
    "static/img/fleet/progress-tier-1.svg",
    "static/img/fleet/progress-tier-2.svg",
    "static/img/fleet/progress-tier-3.svg",
    "static/img/fleet/progress-tier-4.svg",
    "static/img/fleet/progress-tier-5.svg",
        ...
        "backend/services/exchange_fleet_bot_skills_service.py",
        "data/exchange_bot_skills.json",
        ...
        "static/css/youtube-stream-controls.css",
