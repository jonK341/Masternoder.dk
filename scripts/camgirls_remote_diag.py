...
def main() -> int:
    ...
    checks = [
        ...
        (
            "import service",
            f"cd {web} && ./venv/bin/python -c 'import sys; sys.path.insert(0,\"{web}\"); "
        ...
        (
            ...
            "rules=[str(r) for r in app.url_map.iter_rules() if \"camgirl\" in str(r)]; "
            "print(\"\\n\".join(rules) or \"NO CAMGIRLS ROUTES\")' 2>&1",
        ),
