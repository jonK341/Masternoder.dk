#!/usr/bin/env python3
"""
Deploy All Page Routes
Deploys all page routes to production and restarts services
"""
import paramiko
import os
import sys
...
def deploy_all_routes():
    """Deploy all page routes"""
    print("=" * 70)
    print("ALL PAGE ROUTES - Production Deployment")
    print("=" * 70)
    ...
    try:
        ...
        if uwsgi_status == 'active':
            ...
            # Try to start it
            ssh.exec_command("systemctl start uwsgi-vidgenerator", timeout=5)
            time.sleep(2)
        ...
        if proxy_status == 'active':
            ...
            # Try to start it
            ssh.exec_command("systemctl start python-proxy", timeout=5)
            time.sleep(2)
        ...
        print("=" * 70)
        print()
        print("All page routes have been deployed!")
        print("Pages now available:")
        print("  - gallery, battle, shop, chat, debugger")
        print("  - leaderboards, quests, metal, theme-points")
        print("  - battlegrounds, champions-league, and more...")
        print()
        print("Next steps:")
        print("  1. Test pages: https://masternoder.dk/vidgenerator/[page-name]")
