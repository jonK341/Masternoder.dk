#!/usr/bin/env python3
"""
Deploy Social Route Fix
Deploys the social page route fix
"""
import paramiko
import os
import sys
...
def deploy_social_route():
    """Deploy social route fix"""
    print("=" * 70)
    print("Social Route Fix - Production Deployment")
    print("=" * 70)
    ...
    try:
        ...
        print()
        print("Next steps:")
        print("  1. Test: https://masternoder.dk/vidgenerator/social")
