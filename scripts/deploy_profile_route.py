#!/usr/bin/env python3
"""
Deploy Profile Route - Add profile page route
"""
import paramiko
import os
import sys
...
def deploy_profile_route():
    """Deploy profile page route"""
    print("=" * 70)
    print("Profile Route - Production Deployment")
    print("=" * 70)
    ...
    try:
        ...
        print("=" * 70)
        print("✅ Profile Route Deployed!")
        print("=" * 70)
        print()
        print("Profile page now accessible at:")
        print("  - https://masternoder.dk/vidgenerator/profile")
        print()
