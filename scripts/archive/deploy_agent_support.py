...
# -*- coding: utf-8 -*-
"""
Deploy Agent Support to Production  # pragma: allowlist secret
...
def deploy():
    """Deploy agent support files to production"""  # pragma: allowlist secret
    print("="*80)
    print("DEPLOYING AGENT SUPPORT TO PRODUCTION")  # pragma: allowlist secret
    ...
    try:
        ...
        print("Visit: https://masternoder.dk/vidgenerator/agent_support/")  # pragma: allowlist secret
        print()
