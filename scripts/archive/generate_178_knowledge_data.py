    ...
    for system_id in systems:
        ...
        knowledge_entry = {
            ...
            **How it works:**
            ...
            - Supports Death Portal (10x) and Production 10x multipliers  # pragma: allowlist secret
        ...
        if 'production_10x' in system_id:  # pragma: allowlist secret
            knowledge_entry['intelligence_score'] = 100.0
            knowledge_entry['complexity_level'] = 10
            knowledge_entry['learning_curve'] = 'expert'
            knowledge_entry['knowledge_points_value'] = 100
            knowledge_entry['intelligence_points_value'] = 50
            knowledge_entry['description'] = '10x Production system - Maximum production multiplier'  # pragma: allowlist secret
