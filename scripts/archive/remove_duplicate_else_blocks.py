...
# Remove duplicate else blocks (638, 640, 642) and their content
# Lines to remove: 638-639, 640-641, 642-643
lines_to_remove = [637, 638, 639, 640, 641, 642]  # 0-indexed

# Remove in reverse order to maintain indices
for idx in sorted(lines_to_remove, reverse=True):
    if idx < len(lines):
        print(f"Removing line {idx+1}: {lines[idx][:50]}")
        del lines[idx]
