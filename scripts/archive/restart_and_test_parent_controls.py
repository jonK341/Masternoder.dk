...
test_urls = [
    "https://masternoder.dk/vidgenerator/api/parent-controls/parent-groups",  # pragma: allowlist secret
    "https://masternoder.dk/api/parent-controls/parent-groups",  # pragma: allowlist secret
]
