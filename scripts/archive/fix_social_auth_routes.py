...
SERVER_HOST = "masternoder.dk"  # pragma: allowlist secret
SERVER_USER = "root"
...
tests = [
    ('https://masternoder.dk/api/auth/providers', 'Auth Providers (public)'),  # pragma: allowlist secret
    ('https://masternoder.dk/vidgenerator/api/auth/providers', 'Auth Providers (vidgen)'),  # pragma: allowlist secret
    ('http://127.0.0.1:5000/api/auth/providers', 'Auth Providers (direct)'),
    ('https://masternoder.dk/api/user/index?user_id=test', 'User Index'),  # pragma: allowlist secret
    ('https://masternoder.dk/api/user/account-control?user_id=test', 'Account Control'),  # pragma: allowlist secret
]
