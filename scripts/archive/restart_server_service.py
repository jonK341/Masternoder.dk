#!/usr/bin/env python3
"""
Restart Flask service on masternoder.dk server  # pragma: allowlist secret
"""
...
def restart_service():
    ...
    print("=" * 60)
    print("Restarting Flask service on masternoder.dk")  # pragma: allowlist secret
    print("=" * 60)
    print()
    ...
    try:
        ...
        print()
        print("Test the site:")
        print("  https://masternoder.dk/vidgenerator")  # pragma: allowlist secret
        print()
